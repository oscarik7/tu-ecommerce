                        ...
                        <li>
                            <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-lg px-3 py-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
                                ...
                                <div class="flex flex-col">
                                    <span class="text-xs font-bold text-white">Mar-Dom: 13:00-21:00</span>
                                    <span class="text-xs text-purple-300">🚫 Lunes: Cerrado</span>
                                </div>
                            </div>
                        </li>

                        <li>
                            <a href="https://wa.me/595986150627" target="_blank" class="flex items-center gap-2 text-purple-200 hover:text-white transition group">
                                ...
                                <span class="font-semibold">+595 986 150627</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="border-t border-purple-800 pt-6">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="text-center md:text-right">
                        <p class="text-xs text-purple-300">
                            Desarrollado por <a href="https://devparaguay.com" target="_blank" class="font-semibold text-purple-200 hover:text-white transition">Devparaguay</a>
                        </p>
                    </div>
                </div>
            </div>
