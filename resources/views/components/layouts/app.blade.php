...
<body class="bg-gray-50 flex flex-col min-h-screen">
            ...
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li class="flex items-start gap-2">
                            <svg class="w-4 h-4 mt-0.5 flex-shrink-0 text-purple-300" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        {{-- Horario --}}
                        <li>
                            <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md rounded-lg px-3 py-2 border border-white/20 hover:bg-white/15 transition-all duration-300">
                                <svg class="w-4 h-4 text-purple-200 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <div class="flex flex-col">
                                    <span class="text-xs font-bold text-white">{{ $footerSchedule }}</span>
                                    @if($closedDays)
                                        <span class="text-xs text-purple-300">🚫 {{ $closedDays }}: Cerrado</span>
                                    @endif
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <a href="https://wa.me/{{ $storePhone }}" target="_blank"
                               class="flex items-center gap-2 text-purple-200 hover:text-white transition group">
                                <div class="bg-green-500/20 p-1.5 rounded-lg group-hover:bg-green-500/30 transition-colors">
                                ...
                                <span class="font-semibold">{{ $storePhoneShow }}</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="flex gap-3 mb-4">
                        <a href="https://www.instagram.com/taskinhoacaipy/" target="_blank"
                        ...
                        <a href="https://wa.me/{{ $storePhone }}" target="_blank"
                           class="bg-green-600 hover:bg-green-700 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-green-500/50"
                           title="WhatsApp">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
                            </svg>
                        </a>
                        <a href="https://maps.app.goo.gl/SQELP9yYZYx9DPrJ7" target="_blank"
                           class="bg-purple-800 hover:bg-purple-900 p-3 rounded-full transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-purple-500/50"
                           title="Ubicación">
            ...
            <div class="border-t border-purple-800 pt-6">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div class="text-center md:text-right">
                        <p class="text-xs text-purple-300">
                            Desarrollado por <a href="https://devparaguay.com" target="_blank"
                               class="font-semibold text-purple-200 hover:text-white transition">Devparaguay</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <a href="https://wa.me/{{ $storePhone }}?text=Hola!%20Quiero%20hacer%20un%20pedido%20de%20Taskinho%20Açaí"
       ...
       id="whatsapp-float-global">
        ...
        <span class="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-gray-900 text-white text-xs px-3 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none shadow-xl">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(function() {
                const btn = document.getElementById('whatsapp-float-global');
