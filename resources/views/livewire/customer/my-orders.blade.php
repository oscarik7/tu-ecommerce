    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                @foreach($orders as $order)
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <div class="flex flex-wrap items-center justify-between mb-4">
                            <div>
                                <h3 class="text-xl font-bold text-gray-900">Pedido #{{ $order->order_number }}</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div>
                                ...
                                <span class="ml-2">{{ $order->delivery_type == 'delivery' ? '🚚 Delivery' : '🏪 Retiro en Tienda' }}</span>
                            </div>
                            
                            <div>
                                <span class="font-semibold text-gray-700">Productos:</span>
                                <span class="ml-2">{{ $order->items->count() }} items</span>
                            </div>
                            
                            <div>
                                <span class="font-semibold text-gray-700">Total:</span>
                                <span class="ml-2 font-bold text-purple-600">{{ number_format($order->total, 0, ',', '.') }} Gs</span>
                            </div>
                        </div>
        ...
        @else
            <div class="bg-white rounded-lg shadow-md p-12 text-center">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mt-4 mb-2">No tienes pedidos aún</h2>
            ...
            <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto" wire:click.stop>
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2">Entrega</h3>
                            <div class="bg-gray-50 rounded-lg p-4 space-y-2 text-sm">
                        ...
                        <div>
                            <h3 class="font-bold text-lg mb-2">Pago</h3>
                            <div class="bg-gray-50 rounded-lg p-4 space-y-2 text-sm">
                                ...
                                @endif
                                <p class="text-lg"><span class="font-semibold">Total:</span> <span class="text-purple-600 font-bold">{{ number_format($selectedOrder->total, 0, ',', '.') }} Gs</span></p>
                            </div>
                        </div>
