                    ...
                    @foreach($cartItems as $item)
                        <div class="bg-white rounded-lg shadow-md p-4 flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="mt-1">
                                    <span class="inline-block bg-purple-100 text-purple-700 text-xs font-semibold px-2 py-1 rounded-full">
                                ...
                                <p class="text-xs text-gray-500">Stock disponible: {{ $item->variant->stock }}</p>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button wire:click="updateQuantity({{ $item->id }}, {{ $item->quantity + 1 }})" 
                                    ...
                                    class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-1 px-3 rounded disabled:opacity-50 disabled:cursor-not-allowed">
                                    +
                                </button>
                            </div>
